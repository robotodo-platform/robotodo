...
class Articulation:
    ...
    @property
    def link_count(self):
        return self._physics_tensor_get_articulation_view().shared_metatype.link_count

    # TODO
    @property
    def link_names(self):
        return self._physics_tensor_get_articulation_view().shared_metatype.link_names
    ...
    @property
    def dof_count(self):
        return self._physics_tensor_get_articulation_view().shared_metatype.dof_count
