...
class USDLoader:
    ...
    # TODO
    async def destroy(self, entity: Body):
...
# TODO
from robotodo.engines.core.body import BodyKind
from robotodo.engines.isaac._utils_legacy import USDRigidHelper, USDSurfaceDeformableHelper
...
class EntityBuilder:
    ...
    async def create(
        ...
        **config_kwds: Unpack[CreateConfig],
        ...
        # TODO FIXME entity: no path roundtrip; ref underlying prim directly
        return Body(path=prim.GetPath().pathString, scene=scene)
